        ...
        <header className='w-full bg-neutralSilver md:bg-transparent fixed top-0 left-0 right-0'>
            <nav className={`py-4 lg:px-14 px-4 ${isSticky ? "sticky top-0 left-0 right-0 border bg-white duration-300" : ""}`}>
                <div className='flex justify-between items-center text-base gap-8'>
                    <a href='' className='text-2xl font-semibold flex items-center space-x-3'><img src='' alt='' className='w-10 inline-block items-center' /><span className='text-brandPrimary'>NATURALS</span></a>
