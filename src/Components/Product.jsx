                    ...
                    <div className='md:w-2/3 mx-auto'>
                        <div>
                            ...
                            <div className='flex items-center gap-8 flex-wrap'>
                                ...
                                <img src='/src/assets/Logo1.png' alt='' className='cursor-pointer' />
                                <img src='/src/assets/Logo2.png' alt='' className='cursor-pointer' />
                                <img src='/src/assets/Logo3.png' alt='' className='cursor-pointer' />
                                <img src='/src/assets/Logo4.png' alt='' className='cursor-pointer' />
                                <img src='/src/assets/Logo5.png' alt='' className='cursor-pointer' />
                                <div>
